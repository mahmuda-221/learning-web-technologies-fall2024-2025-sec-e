  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-8">
        ...
        <form action="billaction.php?id=<?php echo '$id' . '$bill_id'; ?>" method="POST">

          <div class="form-group">
            <label for="name">ID :</label>
            <input required type="text" class="form-control" name="id" placeholder="vehicle id"
